...
def main():
    ...
    lr_scores = []
    lr_set = [0.0005, 0.005, 0.01, 0.1]
    for lr in lr_set:
        print("Using learning rate : {:.4f}\n".format(lr), end="")
        lr_score, _ = training(learning_rate=lr)
        lr_scores.append(lr_score)
    plot_hyperparameters(lr_scores, output_dir, "learning_rate_scores.png", lr_set, "learning_rate")
    pickle.dump(lr_scores, open("learning_rate_scores.pickle", "wb"))
